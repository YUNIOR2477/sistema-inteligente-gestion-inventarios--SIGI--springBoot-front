...
export const ConfirmDeleteProduct = ({ productId,isMobile, onDone }: DeleteProps) => {
  const { handleDeleteProduct, isLoading } = useProductStore();
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      ToastMessage({
        ...
        description: `Product with ID ${productId} has been removed successfully.`,
      }); 
      onDone();
      setOpen(false);
    } catch (err: unknown) {
