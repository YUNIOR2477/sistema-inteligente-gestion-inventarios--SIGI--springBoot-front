...
export const ConfirmDeleteClient = ({
  ...
  const { handleDeleteClient, isLoading } = useClientStore();
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      ToastMessage({
        type: "success",
        title: response?.message || "Client deleted",
        description: `Client with ID ${clientId} has been removed successfully.`,
      });
      onDone();
      setOpen(false);
    } catch (err: unknown) {
